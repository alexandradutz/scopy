...
cp /usr/lib/python3.5/* appdir/usr/lib/python3.5/
...
sys.path = [ prefix+s for s in sys.path if not s.startswith(prefix) ]" > appdir/usr/lib/python3.5/sitecustomize.py
...
find . | grep python
export PYTHONPATH=${TRAVIS_BUILD_DIR}/build/appdir/usr/lib/python3.5
